...
import { selectFreelances } from '../utils/redux/selectors'
...
// la requête a échoué
export const freelancesRejected = (error) => ({ type: REJECTED, payload: error })

// cette fonction est une action asynchrone, elle attend le store redux en paramètre
